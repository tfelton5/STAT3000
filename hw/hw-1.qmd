...
![Screenshot of R Quarto Document](../img/Screenshot of R Quarto Document.png)
...
2. **GitHub + repo setup**  
   ...
   ![Screenshot of my Github Repo](../img/Screenshot of Github.png)
...
# Plot real roots if they exist
 if (disc >= 0) 
# roots <- # Plot real roots if they exist
if (disc >= 0) {
...
```
quarto render hw/hw-1.qmd
```

11. **Git workflow**

    Make at least **three commits** with meaningful messages, such as:i

```
* Add initial project structure with folders img, data, code, docs
git add -A
git commit -m "Add initial project structure"
git push
```
```
* Implement quadratic discriminant and root calculations in quadratic.qmd
git add .
git commit -m "Implement quadratic discriminant and root calculations"
git push
```
```
* Render project output to docs folder and update repository
git add docs/
git commit -m "Render PDF output to docs folder"
git push
```
...
```
2bbea6c (HEAD -> main, origin/main, origin/HEAD) Add initial project structure
cf6b925 Add initial project structure
7584aec my second commit
3d17757 update docs
6dcdc65 my first commit
```
...
![Screenshot of Github](../img/Screenshot of Github 02:13.png)
* the link to the rendered PDF file in your repo (if applicable)
https://github.com/tfelton5/STAT3000/blob/main/docs/hw-1.pdf
---
